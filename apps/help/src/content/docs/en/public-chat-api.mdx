...
The unprefixed paths `/public/agents/{embedToken}/...` predate versioning. They are an
alias of the `v1` paths: same routes, same responses, same errors. They stay available for
as long as version 1 is served. Use the `v1` paths in new integrations.
