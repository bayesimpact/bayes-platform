...
The unprefixed paths `/public/agents/{embedToken}/...` predate versioning. They answer
exactly like the `v1` paths and stay available for as long as version 1 is served. Use the
`v1` paths in new integrations.
