...
Ils sont un alias des chemins `v1` : mêmes routes, mêmes réponses, mêmes erreurs. Ils
restent disponibles tant que la version 1 est servie. Utilisez les chemins `v1` dans les
