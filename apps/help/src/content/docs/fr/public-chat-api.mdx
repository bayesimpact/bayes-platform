...
Ils servent les routes et les champs de la version 1 qui existaient avant le versionnage, et
restent disponibles tant que la version 1 est servie. Ils ne servent pas la route du HTML des
cartes MCP App, et leur réponse de configuration n'a pas de champ `bannerText`. Utilisez les
chemins `v1` dans les nouvelles intégrations.
