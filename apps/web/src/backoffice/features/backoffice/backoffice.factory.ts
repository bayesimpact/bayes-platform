...
export const backofficeRbacCatalogFactory = BackofficeRbacCatalogFactory.define(({ params }) => ({
  roles: params.roles ?? [
    {
      ...
      permissions: ["app.install", "backoffice.project.read", "backoffice.read", "trace.read"],
    },
    {
  ...
  permissions: params.permissions ?? [
    ...
    { key: "app.install", description: "Install apps on a project" },
    { key: "backoffice.agent.read", description: "See agents in the backoffice" },
    { key: "backoffice.app.manage", description: "Manage app definitions in the backoffice" },
    ...
    { key: "document.create", description: "Create documents in a project" },
    { key: "document.delete", description: "Delete a document" },
    { key: "document.read", description: "See a document" },
    { key: "document.update", description: "Update a document" },
    { key: "document_source.create", description: "Register a document feed on a project" },
    { key: "document_source.delete", description: "Delete a document feed" },
    { key: "document_source.read", description: "See document feeds in a project" },
    { key: "document_source.update", description: "Update a document feed" },
