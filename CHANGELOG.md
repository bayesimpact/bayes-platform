...
- Form agents have a visual output-schema editor: add fields, choose a type, mark them required, and drag to set the question order the assistant follows, with a raw-JSON advanced mode as a fallback
