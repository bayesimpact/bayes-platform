...
**Rule**: Every technical artifact generated by AI (specs, GitHub issues, RFCs, technical docs) MUST be written in ASD-STE100 (Simplified Technical English): short sentences (one instruction per sentence, max ~20 words), active voice, present tense, simple approved vocabulary. This applies to the artifact's content, not to code or code comments.

This repo is public: AI-generated artifacts must also stay client-neutral — never include client names, client-specific labels, or client deployment context.
